...
function HeroSection() {
  ...
  const cardLinkClass =
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-blue-700 motion-safe:hover:scale-[1.02]";

  return (
    <section
      aria-labelledby="hero-heading"
      className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-cyan-600 to-indigo-700 text-white"
    >
      ...
      <div
        aria-hidden="true"
        className="absolute -bottom-40 -left-32 w-96 h-96 bg-indigo-300/10 rounded-full blur-3xl"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1
              id="hero-heading"
              className="text-5xl lg:text-7xl font-extrabold leading-tight mt-8"
            >
              Find Your
            ...
            <div className="flex flex-wrap gap-4 mt-9">
              <Link
                to="/careers"
                className={`bg-white text-blue-700 px-7 py-3.5 rounded-2xl font-semibold flex items-center gap-2 motion-safe:hover:scale-105 transition shadow-xl ${interactiveLinkClass}`}
              >
                Explore Careers
              ...
              <Link
                to="/chatbot"
                className={`border border-white/70 px-7 py-3.5 rounded-2xl font-semibold flex items-center gap-2 hover:bg-white hover:text-blue-700 transition ${interactiveLinkClass}`}
              >
                <Bot
                  size={20}
                  aria-hidden="true"
            ...
            <div className="grid sm:grid-cols-3 gap-3 mt-10 max-w-xl">
              ...
              <Link
                to="/careers"
                className={`bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4 hover:bg-white/20 transition ${cardLinkClass}`}
              >
                <Compass
                  size={23}
          ...
          <div className="relative">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] p-6 shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <Link
                  to="/careers"
                  className={`flex items-center gap-4 bg-white text-slate-800 rounded-2xl p-5 hover:shadow-lg transition ${cardLinkClass}`}
                >
                  <div
                    aria-hidden="true"
